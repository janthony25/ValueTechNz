...
namespace ValueTechNz.Repository.IRepository
{
    ...
    {
        Task<PaginatedList<GetProductsDto>> GetPaginatedProductsAsync(int pageNumber, int pageSize, string? searchTerm, string sortColumn = "DateAdded", string sortOrder = "desc");
